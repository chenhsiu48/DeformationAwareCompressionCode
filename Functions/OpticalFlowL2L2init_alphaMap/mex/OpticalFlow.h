...
public:
	...
	static void SmoothFlowSOR(const DImage& Im1,const DImage& Im2, DImage& warpIm2, DImage& vx, DImage& vy, double& SumPhi,
														 const DImage& alpha,int nOuterFPIterations,int nInnerFPIterations,int nSORIterations, double varepsilon_phi, double varepsilon_psi);
	...
	static void Coarse2FineFlow(DImage& vx,DImage& vy,DImage &warpI2,const DImage& Im1,const DImage& Im2, double& SumPhi, DImage& alpha,double ratio,int minWidth,
															int nOuterFPIterations,int nInnerFPIterations,int nCGIterations, double varepsilon_phi, double varepsilon_psi);

    static void Coarse2FineFlowTali(DImage& vx,DImage& vy,DImage &warpI2,const DImage& Im1,const DImage& Im2, double& SumPhi, DImage& alpha,
															int nOuterFPIterations,int nInnerFPIterations,int nCGIterations, double varepsilon_phi, double varepsilon_psi);
	...
	static void ComputeOpticalFlow(const DImage& Im1,const DImage& Im2,DImage& flow)
	{
		...
		DImage vx,vy,warpI2;
		OpticalFlow::Coarse2FineFlowTali(vx,vy,warpI2,Im1,Im2,SumPhi,alpha,ratio,minWidth,nOuterFPIterations,nInnerFPIterations,nCGIterations);
